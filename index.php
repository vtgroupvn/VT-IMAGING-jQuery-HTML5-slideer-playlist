	...
	jQuery(document).ready(function(){
		...
		var fn_vt_imaging = jQuery('div#vt-imaging').vt_imaging({
			...
			imaging_list:[
				...
				{name:'zoom_out', title: 'zoom_out', description: 'Contact infor.vtgroup@gmail.com. Skype: cuongvt2608', thumbnail:'asset/images/4-t.jpg', src: 'asset/images/4.jpg', audio_src: 'asset/musics/KhocTrongMua.mp3'},
