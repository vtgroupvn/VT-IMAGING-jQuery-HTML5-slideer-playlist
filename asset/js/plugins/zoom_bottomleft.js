window.vt_imaging_delete_app = function(){
	delete window['vt_imaging_plg_zoom_bottomleft'];
}
function vt_imaging_plg_zoom_bottomleft(_self, imaging, audio, div_slide)
{
	...
	**/
	...
	.animate({			
			width: '0px',
			height: '0px',
			top: imaging.position().top + imaging.height()
		}, 1500, function(){
			_self.onCompletePlugin("vt_imaging_plg_zoom_bottomleft", undefined);
	}); 
