...
function vt_imaging_plg_zoom_bottomright(_self, imaging, audio, div_slide)
{
	...
	**/
	...
	.animate({			
			...
			left: imaging.position().left + imaging.width()
		}, 1500, function(){
			_self.onCompletePlugin("vt_imaging_plg_zoom_bottomright", undefined);
	}); 
